...
def generate_hpi_route():
    try:
        ...
        system_message_content = (
            ...
            "and style meticulously. Convert times to 24-hour format. Format fever Tmax (if given) in parentheses if fever as a complaint is provided "
        ...
        user_prompt_instructions = (
            ...
            "1. Gender: male\n"
            "2. Past medical history: hypertension, hyperlipidemia, CKD stage III, esrd on hd (m/w/f), afib\n"
            ...
            "\"with a past medical history of hypertension, hyperlipidemia, chronic kidney disease stage III, and ESRD on hemodialyis (M/W/F) who presents to the Emergency Department "
            ...
            "recent nausea, vomiting, diarrhea, urinary symptoms, or focal neuro deficits. Currently taking Eliquis.\n\n"
